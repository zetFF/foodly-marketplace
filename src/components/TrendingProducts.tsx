...
const trendingProducts: TrendingProduct[] = [
  {
    ...
    chef: {
      name: "Chef Maria",
      image:
        "https://images.unsplash.com/photo-1583394838336-acd977736f90?q=80&w=2568&auto=format&fit=crop",
    },
    rating: 4.9,
    reviewCount: 128,
    tag: "Trending",
  },
  {
    ...
    description:
      "Marinated beef bulgogi, kimchi slaw, and gochujang aioli in soft corn tortillas",
    image:
    ...
    chef: {
      name: "Chef David",
      image:
        "https://images.unsplash.com/photo-1566554273541-37a9ca77b91f?q=80&w=2680&auto=format&fit=crop",
    },
    rating: 4.8,
    reviewCount: 156,
    tag: "Fusion",
  },
  {
    ...
    description:
      "Handmade fettuccine tossed with wild mushrooms in a creamy truffle sauce",
    image:
    ...
    chef: {
      name: "Chef Antonio",
      image:
        "https://images.unsplash.com/photo-1577219491135-ce391730fb2c?q=80&w=2673&auto=format&fit=crop",
    },
    rating: 4.9,
    reviewCount: 203,
    tag: "Gourmet",
  },
  {
    ...
    description:
      "Frozen açaí blend topped with granola, fresh berries, banana, and honey",
    image:
      "https://images.unsplash.com/photo-1501746877-14782df58970?q=80&w=2574&auto=format&fit=crop",
    price: 11.99,
    prepTime: "10 min",
    difficulty: "Easy",
    chef: {
      name: "Chef Emily",
      image:
        "https://images.unsplash.com/photo-1611695267518-8f880f283c7f?q=80&w=2565&auto=format&fit=crop",
    },
    rating: 4.7,
    reviewCount: 187,
    tag: "Healthy",
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12">
          <div
            ...
            <h2 className="text-3xl font-bold text-foodly-900 mb-3">
              Hidangan Spesial Chef
            </h2>
            <p className="text-foodly-600 max-w-2xl">
              Dibuat langsung oleh koki terbaik, hidangan premium ini menjadi
              perbincangan di kota ini
            </p>
          </div>
              ...
              <div className="bg-white rounded-xl overflow-hidden border border-foodly-200 h-full hover:shadow-md transition-shadow">
                <div className="flex flex-col md:flex-row h-full">
                  ...
                  <div className="p-5 md:w-3/5 flex flex-col">
                    <h3 className="font-bold text-xl text-foodly-900 mb-2">
                      {product.name}
                    </h3>
                    ...
                    <div className="flex items-center mb-4">
                      ...
                      />
                      <span className="text-sm text-foodly-900">
                        By {product.chef.name}
                      </span>
                    </div>
                    ...
                    <div className="mt-auto flex items-center justify-between">
                      ...
                      <span className="font-bold text-foodly-900">
