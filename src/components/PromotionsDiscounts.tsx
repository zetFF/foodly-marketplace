...
const samplePromotions: Promotion[] = [
  {
    ...
    description: 'New customers get 15% off their first order above $20.',
...
const PromotionsDiscounts: React.FC<PromotionsDiscountsProps> = ({ showApplyForm = true }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h3 className="font-semibold text-lg mb-4">Available Promotions</h3>
          ...
          {promotions.map((promo) => (
            <div 
              ...
              className={`border rounded-lg overflow-hidden ${
                promo.isSpecial ? 'border-foodly-accent border-2' : 'border-gray-200'
              }`}
            >
              <div className="flex flex-col sm:flex-row">
                <div className={`sm:w-24 p-4 flex items-center justify-center 
                  ${promo.isSpecial ? 'bg-foodly-accent/10' : 'bg-gray-50'}`}
                >
                  <div className="text-center">
                    <Percent className={`h-8 w-8 mx-auto ${
                      promo.isSpecial ? 'text-foodly-accent' : 'text-foodly-600'
                    }`} />
                ...
                <div className="flex-1 p-4">
                  <div className="flex flex-col h-full justify-between">
                    <div>
                      ...
                      <p className="text-sm text-foodly-600 mt-1">{promo.description}</p>
