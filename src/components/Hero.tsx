    ...
    <div className="relative min-h-[90vh] flex items-center">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div 
          ...
          style={{ 
            backgroundImage: "url('https://images.unsplash.com/photo-1604382354936-07c5d9983bd3?q=80&w=2340&auto=format&fit=crop')", 
      ...
      <div className="foodly-container relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            Delicious Food, <br />
            <span className="mt-2 bg-clip-text text-transparent bg-gradient-to-r from-white to-foodly-100">Delivered Fast</span>
          </h1>
          ...
          >
            From local favorites to international cuisines, get the food you're craving delivered to your doorstep with just a few taps.
          </p>
