  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main>
        ...
        {/* <ProductGrid
          title="Hidangan Unggulan"
          subtitle="Temukan hidangan terpopuler kami dari seluruh dunia"
          columns={5}
          aspectRatio="square"
          background="gradient"
        /> */}
          ...
          <div className="foodly-container">
            <div className="text-center mb-8">
              ...
              <p className="text-foodly-600 max-w-2xl mx-auto">
                Manfaatkan penawaran dan diskon eksklusif ini
              </p>
            </div>
        ...
        <section className="py-16 bg-white">
          <div className="foodly-container">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-foodly-900 mb-3">
                Cara Kerja Alysa Foodly
              </h2>
              <p className="text-foodly-600 max-w-2xl mx-auto">
                Dapatkan makanan favorit Anda diantarkan ke rumah Anda dalam
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center p-6 rounded-xl hover:bg-foodly-50 transition-colors">
                ...
                <h3 className="text-xl font-semibold mb-3">Pilih Restoran</h3>
                <p className="text-foodly-600">
                  Jelajahi ratusan menu untuk menemukan makanan yang Anda
                  idamkan
                </p>
              </div>
              ...
              <div className="text-center p-6 rounded-xl hover:bg-foodly-50 transition-colors">
                ...
                <p className="text-foodly-600">
                  Sesuaikan makanan Anda, tambahkan ke keranjang, dan bayar
                  dengan aman secara online
                </p>
              </div>
              ...
              <div className="text-center p-6 rounded-xl hover:bg-foodly-50 transition-colors">
                ...
                <p className="text-foodly-600">
                  Lacak makanan Anda secara real-time dan nikmati saat makanan
                  tersebut tiba di rumah Anda
                </p>
              </div>
            </div>
          ...
          <div className="foodly-container">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-lg mb-8 text-white/90">
                Unduh aplikasi Foodly dan dapatkan pengantaran pertama Anda
                secara gratis!
              </p>
